...
> Sections 6.1 à 6.6 : textes validés, sauf les ajouts marqués « à valider ». Sections 6.7 à 6.13 et 6.14 à 6.18 (nouveaux services) : propositions à valider. Section 6.19 (visuels des en-têtes) et section 6.20 (surtitres et libellés du design) : propositions à valider.
...
**Légende (sous la grille des cartes des services) :** Visuels des cartes : exemples fictifs, les clients et les chiffres sont inventés.
...
> Proposition à valider. Ajoutés avec les maquettes du designer du 26 septembre 2026. Ils ne changent ni l'offre ni le sens des textes : ce sont des petites capitales au-dessus des titres, et quelques libellés.

**Présentation :**
- Chaque titre de section a un surtitre (tableau ci-dessous).
- Une partie de chaque grand titre est en gras, par exemple « Parlons de votre **projet** ».
...
- Page Audit gratuit, « Ce que nous vérifions » : chaque point a un titre (« Vitesse ») et une phrase qui commence par une majuscule (« Combien de temps vos pages mettent à s'afficher, et pourquoi. »).
